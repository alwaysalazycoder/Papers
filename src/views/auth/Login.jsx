    ...
    <div className='bg-light-blue p-4 '>
      <div id='inputForm' className='h-full  '>
        ...
        <div className='w-full flex justify-center'>
          <input type="button" value="Login" className='bg-gradient-to-b from-violet-400 to-purple-400 w-[50%] rounded-xl mx-4 p-2 mt-8 text-black text-center text-xl  shadow-inner ' onClick={() => handleForm(input.userName, input.password)} />
        </div>

        <div className='text-center my-3 text-[10px]' >
          Don't have account?<span className='text-blue-700' onClick={() => nevigate("/auth/sign-up")}> SignUp</span>
        </div>

        <h2 className=' border-b-[1px] border-black text-center leading-[1px] my-4'><span className='bg-light-blue px-2'>or</span></h2>

        <div class="px-6 sm:px-0 w-[100%] mt-12 mx-auto">
          <button type="button" class="text-white w-full  bg-[#377ff3] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center justify-between dark:focus:ring-[#4285F4]/55 mr-2 mb-2"><svg class="mr-2 -ml-1 w-4 h-4" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512"><path fill="currentColor" d="M488 261.8C488 403.3 391.1 504 248 504 110.8 504 0 393.2 0 256S110.8 8 248 8c66.8 0 123 24.5 166.3 64.9l-67.5 64.9C258.5 52.6 94.3 116.6 94.3 256c0 86.5 69.1 156.6 153.7 156.6 98.2 0 135-70.4 140.8-106.9H248v-85.3h236.1c2.3 12.7 3.9 24.9 3.9 41.4z"></path></svg>Sign up with Google<div></div></button>
        </div>
      </div>
      <div className='text-center mt-3 text-[10px]' >
        Are you Admin?<span className='text-blue-700' onClick={() => nevigate("/auth/login-admin")}> Admin Login</span>
      </div>
