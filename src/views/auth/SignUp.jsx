  ...
  return (
    <div className='bg-light-blue p-4  '>
      <div id='inputForm' className='h-full  '>
        <h1 className='text-center mb-4 text-bright-blue font-bold font-mono text-[30px] tracking-widest drop-shadow-[1px_1px_1px_#8c6fa9]  '>SIGNUP</h1>


        <div id='username' className='bg-white px-4 py-1 mx-4 my-1 flex rounded-[10px] align-middle' >
          <div id="userName" className="p-2 text-xl cursor-pointer"><i className="fa-solid fa-user "></i></div>
        ...
        <div id='email' className='bg-white px-4 py-1 mx-4 my-6 flex rounded-[10px] align-middle' >
          <div id="email" className="p-2 text-xl cursor-pointer"><i className="fa-solid fa-envelope"></i></div>
        ...
        <div id='mobileNumber' className='bg-white px-4 py-1 mx-4 my-1 flex rounded-[10px] align-middle' >
          <div id="mobileNumber" className="p-2 text-xl cursor-pointer"><i className="fa-solid fa-mobile"></i></div>
        ...
        <div id="password" className='bg-white px-4 py-1 mx-4 mt-6 flex rounded-[10px] align-middle'>
          <div id="password" className="p-2 text-xl cursor-pointer" ><i className="fa-solid fa-lock"></i></div>
        ...
        <div id="confirmPassword" className='bg-white px-4 py-1 mx-4 my-6 flex rounded-[10px] align-middle'>
          <div id="password" className="p-2 text-xl cursor-pointer" ><i className="fa-solid fa-lock"></i></div>
        ...
        <div className='w-full flex justify-center'>
          <input type="button" value="Create Account" className='bg-gradient-to-b from-violet-400 to-purple-400 w-[50%] rounded-xl mx-4 p-2 mt-8 text-black text-center text-xl  shadow-inner  cursor-pointer' />
        </div>
        <div className='text-center my-3 text-[10px]' >
          Already have an account?<span className='text-blue-700 cursor-pointer' onClick={() => nevigate("/auth/login")}> Login</span>
        </div>
